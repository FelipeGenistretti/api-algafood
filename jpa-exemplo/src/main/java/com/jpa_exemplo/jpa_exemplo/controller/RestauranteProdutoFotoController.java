...
public class RestauranteProdutoFotoController {
    ...
    public void atualizarFoto(@PathVariable Long restauranteId, @PathVariable Long produtoId, @RequestParam MultipartFile arquivo, @Valid @ModelAttribute FotoProdutoRequestDTO dto ) {
